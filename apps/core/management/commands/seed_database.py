...
class Command(BaseCommand):
    ...
    def create_users(self, count, verbose=False):
        ...
        for i, customer_data in enumerate(
            customers[: count - 2]
        ):  # -2 for admin and staff
    ...
    def create_tags(self, verbose=False):
        ...
        self.stdout.write(self.style.SUCCESS(f"✅ Created {tags_created} tags"))
    ...
    def create_products(self, count, verbose=False):
        ...
        products_templates = {
            ...
            "men's clothing": [
                ...
                },
                {
                    ...
                    "price": 29.99,
                    "description": "Set of 3 basic t-shirts",
                },
                {
                    "name": "Wool Sweater",
                    "price": 89.99,
            ...
            "women's clothing": [
                ...
                },
                {
                    "name": "Yoga Leggings",
                    "price": 39.99,
                    "description": "High-quality athletic leggings",
                },
                {
                    "name": "Silk Blouse",
                    "price": 129.99,
            ...
            "books": [
                ...
                },
                {
                    ...
                    "price": 14.99,
                    "description": "Exciting sci-fi adventure",
                },
            ],
            "furniture": [
                {
        ...
        for i in range(count):
            ...
            templates = products_templates.get(
                category_key,
                [
                    {
                        "name": f"Product {i+1}",
                        "price": 99.99,
                        "description": f"Quality product in {category.name}",
                    }
                ],
            )
