...
class ProductAPITestCase(APITestCase):
    ...
    def test_create_product_unauthorized(self):
        ...
        url = reverse("product-list")
        data = {"name": "New Product", "price": "49.99", "category": self.category.id}
...
class ProductModelTestCase:
    ...
    def test_is_low_stock_property(self):
        ...
        product1 = ProductFactory(
            track_inventory=True, stock_quantity=10, low_stock_threshold=5
        )
    ...
    def test_discount_percentage_property(self):
        ...
        product = ProductFactory(
            price=Decimal("100.00"), compare_price=Decimal("120.00")
        )
        assert (
            product.discount_percentage == 17
        )  # (120-100)/120 * 100 = 16.67 rounded to 17
