...
def main():
    ...
    test_endpoint("Product Testing Instructions", "GET", f"{API_BASE}/products/testing-instructions/")
    print()
    ...
    test_endpoint("Register User", "POST", f"{API_BASE}/auth/register/", {
        "email": "testuser@example.com",
        "username": "testuser_v1",
        "password": "testpass123456",
        "password_confirm": "testpass123456"
    })
    test_endpoint("Login User", "POST", f"{API_BASE}/auth/token/", {
        "email": "testuser@example.com",
        "password": "testpass123456"
    })
    test_endpoint("Auth Testing Instructions", "GET", f"{API_BASE}/auth/testing-instructions/")
    print()
